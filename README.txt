...
Description: For Homework 5, I created two python files, scrape.py and plot.py. Scrape.py is a .py file with scraping the data, the primary python file, and plot.py is a .py file with 
getting analysis graphs for this project.
